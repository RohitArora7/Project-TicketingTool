...
$http.post('databaseFiles/insertDetails.php',{"name":$scope.formData.name,"subject":$scope.formData.subject,"body":$scope.formData.body,"team":$scope.team,"ticket_to":$scope.formData.ticket_to,"option":'Ticket_insert'}).then(function(data){
if (data.data == true) {
...
$http.post('databaseFiles/empDetails.php',{"name":$scope.a}).then(function(data){
...
$scope.second_m=1;
	//$state.go('login');
	$scope.a =$localStorage.session
$http.post('databaseFiles/empDetails2.php',{"name":$scope.a}).then(function(data){
...
{
$scope.show_data=1;
	$http.post('databaseFiles/insertDetails.php',{"name":a,"option":'Ticket_comment'}).then(function(data){
...
$http.post('databaseFiles/insertDetails.php',{"name":c.model,"subject":a,"option":'Ticket_status_update_transfer',"body":b,"to":d.model,"from":e}).then(function(data){
if (data.data == true) {
...
$http.post('databaseFiles/insertDetails.php',{"name":c.model,"subject":a,"option":'Ticket_status_update',"body":b}).then(function(data){
if (data.data == true) {
