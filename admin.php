...
<div style="position:absolute;left:190px;top:190px;width:784px;height:400px;background-color:white">

<div  ng-show="one_m" style="position:absolute;left:20px;top:10px;">


<button  ui-sref=".form" ng-click="formshow()" >Create a Ticket</Button><button  ng-click="getInfo4()" >All Tickets</Button><button  ng-click="getInfo5()" >Admin Tickets</Button><br><br>
...
<input ng-model="q" id="search" class="form-control" placeholder="Filter text"><input type="number" min="1" max="50" class="form-control" ng-model="pageSize">
  ...
  <!--<a ui-sref=".form" >Form</a>-->
        ...
        <tr class="table_row">
            <th class="table_head" width="5%">Ticket no.</th>
            <th class="table_head"  width="10%">Name</th>
			<th class="table_head"  width="20%">Subject</th>
			<th class="table_head"  width="10%">Status </th>
			<th class="table_head" width="10%" ng-click="sort('date_time')">Date </th>
...
<td class="table_data">
<button ng-click="readshow(detail,'admin')" >Read</button><button ui-sref=".userinfo" ng-click="getInfo3(detail.userid)" >User Info</button><button ng-click="getInfo6(detail,'admin')" >Edit</button><button ui-sref=".userinfo" ng-click="getInfo3(detail.userid)" >Delete</button>	
</td>
...
<button  ui-sref=".form" ng-click="formshow()" >Create a Ticket</Button><button  ng-click="getInfo4()" >All Tickets</Button><button  ng-click="getInfo5()" >Work Tickets</Button>
<br><br>
...
<input ng-model="q" id="search" class="form-control" placeholder="Filter text"><input type="number" min="1" max="50" class="form-control" ng-model="pageSize">
  ...
  <!--<a ui-sref=".form" >Form</a>-->
         ...
         <tr class="table_row">
			...
			<th class="table_head" ng-click="sort('date_time')">Date </th>
		<!--	<th class="table_head">Team</th>-->
			<th class="table_head">Assign to</th>
...
<td class="table_data">{{detail.id}}</td>
<td class="table_data">{{detail.name}}</td>
<td class="table_data">{{detail.subject}}</td>
<td class="table_data" ng-class="detail.status">{{detail.status}}</td>
<td class="table_data">{{detail.date_time}}</td>
...
<td class="table_data">
<button ng-click="readshow3(detail,'admin')" >Read</button>	
</td>
...
<div style="position:absolute;left:1000px;top:150px;width:484px;height:500px;background-color:#F5F5F5;overflow-x: hidden;overflow-y: scroll;">
...
<table class="table2" >
<br>
<span style="font-size: 150%;padding-left:150px;">Team Ticket</span>
<br><br>
 <tr class="table_row2">
...
-->
 ...
 > <select name="type" ng-model="$parent.t_token" ng-options="optionn.model for optionn in option_f"  >
  ...
  <td class="table_data2">  Comment<textarea  id="third" ng-model="$parent.formDataa"  rows="5" cols="47"></textarea><br><button ng-click="read_update(detail.id,formDataa,payment,t_token,'Admin','wt')" >Submit</button></td>
  </tr>
...
<!--
 ...
 > <select name="type" ng-model="$parent.t_token" ng-options="optionn.model for optionn in option_f"  >
   ...
   <tr class="table_row2">
  <td class="table_data2"></td>
  <td class="table_data2">  Comment<textarea  id="third" ng-model="$parent.formDataa"  rows="5" cols="47"></textarea><br><button ng-click="read_update(detail.id,formDataa,payment,null,detail.name,'mt')" >Submit</button></td>
  </tr>
...
<table class="table3" >
 ...
 <tr class="table_row3" ng-repeat="com in comment  "  >
     ...
     <td class="table_data3"><span style="font-size: 60%;">{{com.date_time}}</span><br>	{{com.status}}<br><span style="font-size: 60%;">{{com.comment_from}}<span ng-if="com.comment_to!=' '"  > > </span> {{com.comment_to}}</span> </td>
     <td class="table_data3">{{com.comment}}</td>
 </tr>
...
<div ng-show="show_data3" >

<div  ng-repeat="detail in details2  "   >

<table class="table2" >
<br>
<span style="font-size: 150%;padding-left:150px;">Edit Ticket</span>
<br><br>
 <tr class="table_row2">
  <td class="table_data2" style="" >Name:</td>
  <td class="table_data2">{{detail.name}}</td>
...
<tr class="table_row2">
  <td class="table_data2">Subject:</td>
  <td class="table_data2">	<span ng-show="detail.editing==0">{{detail.subject}}</span><span ng-hide="detail.editing==0"><input type='text' ng-model='detail.subject'/><button ng-click="save_ticket(detail.id,detail.subject);detail.editing=0" >save</button></span><button ng-click="detail.editing=1" >Edit</button></td>
  </tr>
...
<div ng-if='token_form' ng-controller="Control" ng-include="'form.php'"></div>


<div ng-if='token_read' ng-controller="Control" ng-include="'read.php'"></div>